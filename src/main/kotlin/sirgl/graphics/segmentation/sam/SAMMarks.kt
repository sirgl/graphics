...
//import sirgl.graphics.segmentation.LabMatrix
...
//}
//
//fun splitAndMerge(src: ImgLike, res: ImgLike, metricFunc: (LAB, LAB) -> Double = sirgl.graphics.segmentation::computeCiede2000Metrics, threshold: Float = THRESHOLD) {
//    val matrix = LabMatrix(src)
//    val region = Region(src, matrix, threshold)
//    split(region, metricFunc)
//    var currentMark = 0
//    region.leafPass {
//        it.areaMark = currentMark
...
//    region.leafPass {
//        val areaMark = it.getLeadingRegion().areaMark
...
//            res.setRGB(x, y, markToColor[it.getLeadingRegion().areaMark]!!)
//        }
//    }
//}
//
...
//
//    fun getLeadingRegion(): Region {
//        var currentNextRegion: Region = nextRegion ?: return this
//        while (true) {
//            val probablyNext = currentNextRegion.nextRegion
//            if (probablyNext == null) {
//                return currentNextRegion
//            } else {
//                areaMark = probablyNext.areaMark
//                currentNextRegion = probablyNext
//            }
//        }
//    }
//
...
//        if (getLeadingRegion().areaMark == neighbor.getLeadingRegion().areaMark) return false
////        matrix.forEach(xStart, yStart, xEnd, yEnd) { _, _, lab1 ->
